...
/* djb2 hash function by Daniel Bernstein*/
...
int main(){
    ...
    printf("Item a saved to HashTable\n");
    printf("Set breakpoint here to examine memory heap \n");
    
    HashTable_delete(h, "item a");
    printf("Item a removed from HashTable\n");
    printf("Set breakpoint here to examine memory heap \n");
